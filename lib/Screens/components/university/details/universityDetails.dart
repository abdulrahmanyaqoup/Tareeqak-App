...
class UniversityDetail extends StatelessWidget {
  ...
  const UniversityDetail({super.key, required this.university});
    ...
    return DetailBase(
      ...
      buttons: [
        ...
        UniversityButtons(
          ...
          onPressed: () {
            _launchURL('https://www.google.com/maps/place/University+of+Jordan/@32.0161048,35.8695456,15z/data=!4m6!3m5!1s0x151c9f765ba05b27:0x5a5ba049c504b635!8m2!3d32.0161048!4d35.8695456!16zL20vMDdxc2Q1?entry=ttu');
          },
        ),
        UniversityButtons(
          icon: Icons.school,
          ...
          onPressed: () {
            _showGridModalBottomSheet(context, 'University Schools', university.schools);
          },
        ),
      ],
    );
  ...
  void _showGridModalBottomSheet(BuildContext context, String title, List<dynamic> items) {
    showModalBottomSheet(
      context: context,
      builder: (context) {
